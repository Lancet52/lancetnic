...
| **Применение** | Биниарная и многоклассовая классификация данных | Длинные последовательности, временные ряды | Табличные данные, простейшие признаки |

## Структура результата обучения
```markdown
📁 runs/
├── 📁 train_0/ # Проект
